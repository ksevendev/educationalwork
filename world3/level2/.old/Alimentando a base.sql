...
VALUES 
    (1, 'Milena Oliveira', 'Rua das Flores 123', 'São Paulo', 'SP', '11987654321', 'milena@email.com'),
    (2, 'Paulo Silva', 'Avenida Central 456', 'Rio de Janeiro', 'RJ', '21987654321', 'paulo@email.com'),
    (3, 'Maria Santos', 'Travessa Exemplo 789', 'Belo Horizonte', 'MG', '31987654321', 'maria@email.com'),
